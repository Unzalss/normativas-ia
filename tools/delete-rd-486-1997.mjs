...
const TARGET_CODIGO = "RD-486-1997";
...
function printPlan({ normas, fragmentCount, confirmDelete }) {
  console.log("\n[DELETE_RD_486_1997] Plan de borrado seguro");
...
async function deleteTargetNorma() {
  ...
  console.log("\n[DELETE_RD_486_1997] Borrado completado");
...
deleteTargetNorma().catch((error) => {
  console.error(`[DELETE_RD_486_1997][ERROR] ${error.message}`);
  process.exit(1);
});
